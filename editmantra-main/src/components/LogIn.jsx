  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        role === "admin"
          ? "https://editmantra-backend.onrender.com/admin-login"
          : "https://editmantra-backend.onrender.com/user-login",
        requestData
      );
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow flex items-center bg-blue-300 justify-center bg-cover bg-center p-3">
        {/* Card Container */}
        <div className="relative z-10 flex flex-col md:flex-row w-full max-w-4xl bg-white rounded-lg shadow-2xl p-8">
          {/* Left Side - Project Info */}
          <div className="w-full md:w-1/2 flex flex-col justify-center p-6 bg-gray-100 rounded-t-lg md:rounded-l-lg md:rounded-tr-none">
          ...
          <div className="w-full md:w-1/2 p-4 rounded-b-lg md:rounded-b-none md:rounded-r-lg">
            ...
            <div className="mt-4 text-center font-semibold text-xl">
              ...
              <a href="/signup" className="text-blue-600 underline hover:text-cyan-500">
                Click here
              </a>
            </div>
          </div>
