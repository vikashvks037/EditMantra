...
const Gamification = () => {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Header />
      <div className="flex-grow flex flex-col justify-center items-center bg-[#4b7ad1]">
        <div className="animate-blink text-center">
          {showLink && (
            <Link
              onClick={handleClick} // Trigger the state update on click
              className="text-uppercase text-4xl font-semibold tracking-widest relative flex items-center hover:scale-105 transform transition-transform cursor-pointer flex-col text-blue-100"
            >
