...
function AdminRealTimeCollaboration() {
  ...
  const verifyUsername = async () => {
    try {
      const response = await axios.post('https://editmantra-backend.onrender.com/verify-username', { username });
  ...
  const joinRoom = async (e) => {
    ...
    navigate(`/Dashboard/AdminRealTimeCollaboration/Editor/${roomId}`, { state: { username } });
  };
...
export default AdminRealTimeCollaboration;
