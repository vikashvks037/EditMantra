  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto p-6">
        {/* Main Heading */}
        <h1 className="text-3xl sm:text-4xl lg:text-5xl text-gray-700 font-extrabold text-center mb-6 ">Online Compiler with Realtime Collaboration</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <div onClick={() => handleRedirect('/LearningResources')} className="bg-cyan-300 p-6 rounded-lg shadow-lg hover:scale-105 transform transition-transform cursor-pointer hover:shadow-2xl flex flex-col items-center">
            <div className="mb-6"><img src="/Learning.jpg" alt="Learning Resources" className="w-28 h-28 rounded-full border-4 border-blue-400"/>
            </div>
            <h3 className="text-2xl font-semibold text-cyan-700 mb-3 text-center">Search Books for Learning</h3>
          ...
          <div onClick={() => handleRedirect('/RealTimeCollaboration')} className="bg-purple-300 p-6 rounded-lg shadow-lg hover:scale-105 transform transition-transform cursor-pointer hover:shadow-2xl flex flex-col items-center">
            ...
            <h3 className="text-2xl font-semibold text-purple-700 mb-3 text-center">Real-Time Collaboration</h3>
            <p className="text-gray-700 text-center font-semibold ">Work on coding projects together with your friends in real time.</p>
            </div>
          {/* Gamification Card */}
          <div onClick={() => handleRedirect('/Gamification')} className="bg-green-300 p-6 rounded-lg shadow-lg hover:scale-105 transform transition-transform cursor-pointer hover:shadow-2xl flex flex-col items-center" >
            ...
            <h3 className="text-2xl font-semibold text-green-700 mb-3 text-center"> Solve Questions </h3>
